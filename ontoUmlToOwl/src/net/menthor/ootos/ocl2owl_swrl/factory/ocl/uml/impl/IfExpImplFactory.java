 ...
 */
public class IfExpImplFactory extends OCLExpressionImplFactory {

	public IfExpImplFactory(MappingElements mappingProperties, OwlOptions owlOptions, NamedElementImpl m_NamedElementImpl){
