 ...
 */
public class StateExpImplFactory extends OCLExpressionImplFactory {

	public StateExpImplFactory(MappingElements mappingProperties, OwlOptions owlOptions, NamedElementImpl m_NamedElementImpl){
