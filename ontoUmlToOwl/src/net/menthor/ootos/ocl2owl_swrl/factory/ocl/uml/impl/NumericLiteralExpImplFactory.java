 ...
 */
public class NumericLiteralExpImplFactory extends PrimitiveLiteralExpImplFactory {

	public NumericLiteralExpImplFactory(MappingElements mappingProperties, OwlOptions owlOptions, NamedElementImpl m_NamedElementImpl){
