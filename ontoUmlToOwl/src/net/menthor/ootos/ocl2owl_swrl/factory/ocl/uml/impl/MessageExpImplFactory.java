 ...
 */
public class MessageExpImplFactory extends OCLExpressionImplFactory {

	public MessageExpImplFactory(MappingElements mappingProperties, OwlOptions owlOptions, NamedElementImpl m_NamedElementImpl){
