 ...
 */
public class IterateExpImplFactory extends LoopExpImplFactory {

	public IterateExpImplFactory(MappingElements mappingProperties, OwlOptions owlOptions, NamedElementImpl m_NamedElementImpl){
