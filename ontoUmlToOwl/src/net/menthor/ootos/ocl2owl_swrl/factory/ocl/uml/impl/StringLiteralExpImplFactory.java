 ...
 */
public class StringLiteralExpImplFactory extends PrimitiveLiteralExpImplFactory {

	public StringLiteralExpImplFactory(MappingElements mappingProperties, OwlOptions owlOptions, NamedElementImpl m_NamedElementImpl){
