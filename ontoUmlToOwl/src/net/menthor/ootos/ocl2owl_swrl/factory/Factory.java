package net.menthor.ootos.ocl2owl_swrl.factory;
...
import net.menthor.ootos.ocl2owl_swrl.exceptions.UnsupportedByReasoner;
import net.menthor.ootos.ocl2owl_swrl.factory.ocl.uml.impl.BooleanLiteralExpImplFactory;
import net.menthor.ootos.ocl2owl_swrl.factory.ocl.uml.impl.CollectionItemImplFactory;
import net.menthor.ootos.ocl2owl_swrl.factory.ocl.uml.impl.CollectionLiteralExpImplFactory;
import net.menthor.ootos.ocl2owl_swrl.factory.ocl.uml.impl.EnumLiteralExpImplFactory;
import net.menthor.ootos.ocl2owl_swrl.factory.ocl.uml.impl.IntegerLiteralExpImplFactory;
import net.menthor.ootos.ocl2owl_swrl.factory.ocl.uml.impl.IteratorExpImplFactory;
import net.menthor.ootos.ocl2owl_swrl.factory.ocl.uml.impl.LetExpImplFactory;
import net.menthor.ootos.ocl2owl_swrl.factory.ocl.uml.impl.OperationCallExpImplFactory;
import net.menthor.ootos.ocl2owl_swrl.factory.ocl.uml.impl.PropertyCallExpImplFactory;
import net.menthor.ootos.ocl2owl_swrl.factory.ocl.uml.impl.TypeExpImplFactory;
